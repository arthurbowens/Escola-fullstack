package com.arthur.gestaoEscolar.util;
...
public class JwtUtil {
    ...
    private static final Key SECRET_KEY = Keys.hmacShaKeyFor("minhaChaveSecretaMuitoLongaParaHS512Algoritmo123456789".getBytes());
